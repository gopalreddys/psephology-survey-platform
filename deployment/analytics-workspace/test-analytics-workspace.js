...
assert.match(repository, /MINIMUM_SEGMENT_BASE/);
assert.match(repository, /voter\.mandal_name_source AS mandal_name/);
assert.match(repository, /directFivePointIndex/);
assert.match(repository, /Direct respondent rating only/);
