...
export default function NewCampaignPage() {
  ...
  async function save() {
    if (!generatedCampaignCode || !form.name.trim() || !form.programId || !target || !mandals.length) { setMessage("Complete the campaign details, select an assigned research program and confirm a verified target geography."); return; }
