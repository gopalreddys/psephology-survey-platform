...
type Campaign = { id: string; campaign_code: string; campaign_name: string; target_domain: string; target_type: string; target_name: string; target_code: string | null; status: string; created_by_name: string | null; start_date: string | null; end_date: string | null; scope: ScopeRow[]; allocations: Allocation[] };
