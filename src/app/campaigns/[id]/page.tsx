...
type CampaignIteration = { id: string; campaign_id?: string | null; study_id: string; iteration_number: number; iteration_name: string; research_phase: string; status: string; target_sample_size: number | null; planned_start_date: string | null; run_count?: number; completed_run_count?: number; allocation_editable?: boolean; successful_voters?: number; voice_agent_id?: string | null; voice_agent_name?: string | null; voice_agent_category?: string | null; voice_agent_app_id?: string | null; voice_agent_app_version?: number | null };
